<%-- 
    Document   : index
    Created on : 7/10/2024, 8:19:03 p. m.
    Author     : Win11
--%>
      ...
      <div class="modal-body">
        <form action="sr_empleado" method="post" class="form-group">
                ...
                <div class="btn-group" role="group" aria-label="Basic outlined example">
                    <button name="btn_agregar" id="btn_agregar" value="agregar" class="btn btn-secondary"> Agregar  <i class="bi bi-floppy-fill"></i></button>
                    <button name="btn_modificar" id="btn_modificar"  value="modificar" class="btn btn-primary"> Modificar  <i class="bi bi-gear"></i></button>
                    <button name="btn_eliminar" id="btn_eliminar"  value="eliminar"  class="btn btn-danger" onclick="javascript:if(!confirm('¿Desea Eliminar?'))return false" > Eliminar  <i class="bi bi-trash3-fill"></i></button>
                </div>
